...
** TODO Contain Lu Yang about back pay once the contract gets signed
** TODO Add custom code from chain-new into gitlab
** TODO Moving my work notes back to an electronic version. I had been working on paper, but for work and for calendaring, I am moving back to electronic versions.
** Working from campus. This is my second Monday.
** TODO Need to update my work stuff and my calendar stuff when I get home.
** TODO Update Matlab Release on the web site.
